...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo
		jalan(' \033[1;92mWarning:\033[1;91m Do Not Use Your Personal FB Account' )
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe Termux Tutorial YouTube Channel " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mXABIHA\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
	...
	p.map(main, id)
#Dev:Babar_Ali
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mSABIHA\033[1;95m-_-_-_-_-_-_-_-_-»"
